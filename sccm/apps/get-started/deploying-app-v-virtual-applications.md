...
|Migrez les groupes de connexion App-V 5 vers des environnements virtuels Configuration Manager.|Consultez la section [Migrer les groupes de connexion App-V 5 vers des environnements virtuels Configuration Manager](/sccm/apps/get-started/deploying-app-v-virtual-applications#migrating-app-v-5-connection-groups-to-configuration-manager-virtual-environments) de cette rubrique.|  
