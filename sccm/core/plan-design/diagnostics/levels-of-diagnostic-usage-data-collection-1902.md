...
- ***[Nouveau]***  Existence des extensions Microsoft BitLocker Administration and Monitoring (MBAM) côté serveur  
...
- Nombre de requêtes CMPivot enregistrées  
...
- Top des codes d’erreur UUP et nombre d’appareils affectés  
