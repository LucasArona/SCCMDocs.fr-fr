---
title: 'Opérations et maintenance pour les rapports '
...
4. Sur la page **Informations** , configurez les paramètres suivants :  
   ...
   - **Chemin d’accès** : Cliquez sur **Parcourir** pour spécifier un dossier dans lequel vous souhaitez stocker le rapport.  
...
4. Sur la page **Remise d'abonnement** , configurez les paramètres suivants :  
   ...
   - **Chemin d’accès** : Spécifiez un chemin UNC vers un dossier existant, dans lequel vous souhaitez remettre ce rapport \(par exemple, \\\\&lt;nom_serveur\>\\&lt;partage_serveur\>\\&lt;dossier_rapport\>\).  
   ...
   - **Format de rendu** : Sélectionnez l'un des formats suivants pour le fichier de rapport :  
     ...
     -   **Convertisseur RPL** : Enregistre le rapport au format Report Page Layout \(RPL\).  
