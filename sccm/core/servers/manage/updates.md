...
| Version | Date de disponibilité | [Date de fin de support](/sccm/core/servers/manage/current-branch-versions-supported) | Base de référence | Mise à jour dans la console |  
|-------------|-----------|------------|--------------|------------------------|  
