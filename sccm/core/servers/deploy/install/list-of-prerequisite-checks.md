...
### <a name="security-rights-errors"></a>Droits de sécurité : erreurs
...
### <a name="dependencies-errors"></a>Dépendances : erreurs
...
*S’applique à : site principal* Le code de site spécifié n’est pas déjà en cours d’utilisation dans la hiérarchie Configuration Manager. Spécifiez un code de site unique pour ce site.
...
### <a name="system-requirements-errors"></a>Configuration système requise : erreurs
