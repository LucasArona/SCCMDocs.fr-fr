...
Dans la version 1902, ce paramètre est maintenant intitulé **Préférer les sources basées sur le cloud aux sources locales**. Le comportement reste le même.<!-- SCCMDocs#1529 -->
...
Quand vous basculez vers un nouveau serveur, les appareils utilisent l’action de secours pour rechercher ce serveur. Les clients basculent vers le nouveau point de mise à jour logicielle lors de leur cycle suivant d’analyse des mises à jour logicielles.<!-- SCCMDocs#1537 -->
