...
<!-- 1357389 --> Pour les nouvelles classes ajoutées, des chaînes supérieures à 255 caractères peuvent être spécifiées pour les propriétés d’inventaire matériel qui ne sont pas des clés.
...
<!-- 1351224 & 1355146 --> Dans cette version Technical Preview, des améliorations ont été apportées à la personnalisation du Centre logiciel sous les paramètres client. 
...
<!-- 1356256 --> Pour les appareils avec Windows 10 version 1709 et ultérieur, il existe deux nouveaux paramètres d’interaction d’hôte pour [Windows Defender Application Guard](/sccm/protect/deploy-use/create-deploy-application-guard-policy). 
...
<!-- 1236459 --> La fonctionnalité [**Exécuter les scripts**](/sccm/apps/deploy-use/create-deploy-scripts) vous permet désormais d’importer et d’exécuter des scripts PowerShell signés. 
