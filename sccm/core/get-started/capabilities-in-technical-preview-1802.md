...
Pour plus d’informations, consultez l’option **Groupe** du mode de distribution dans [Options d’Optimisation de la distribution](/windows/deployment/update/waas-delivery-optimization#how-microsoft-uses-delivery-optimization).
...
- Mêmes [exigences pour la Passerelle de gestion cloud](/sccm/core/clients/manage/cmg/plan-cloud-management-gateway#requirements), à l’exception du certificat de gestion Azure.
